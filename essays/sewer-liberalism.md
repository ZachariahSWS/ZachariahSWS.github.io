...
Other jurisdictions like Los Angeles have similar problems, but not to quite the same scale. They will all benefit from a proactive governor or legislature willing to go to bat for transit construction even without extra funding. Boston shows that [cost savings can be made](https://www.slowboring.com/p/fancy-stations-make-quality-mass){: .external-link} if an executive is willing but stupid barriers remain such as [zoning codes blocking construction](https://blockclubchicago.org/2023/05/19/city-approves-development-plan-along-long-anticipated-red-line-extension/){: .external-link}. For goodness' sake, all government construction should be by right.
